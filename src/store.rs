...
use windows::{
    ...
    Win32::Security::Cryptography::{
        ...
        CERT_STORE_OPEN_EXISTING_FLAG, CERT_SYSTEM_STORE_CURRENT_SERVICE_ID,
        ...
        HCERTSTORE, HCRYPTPROV_LEGACY, PKCS12_INCLUDE_EXTENDED_PROPERTIES, PKCS12_PREFER_CNG_KSP,
